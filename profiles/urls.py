...
from .views import UserProfileView, UserProfileEditView, NewApplicationsView
...
urlpatterns = [
    ...
    path('<slug:phone>/applications/<int:pk>/', NewApplicationsView.as_view(), name='application_detail'),
]
